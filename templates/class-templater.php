...
class ShopimintTemplater
{
    ...
    public function register()
    {
        ...
        if (version_compare($wp_version, '4.7', '<')) {
            ...
            add_filter(
                'page_attributes_dropdown_pages_args', array($this, 'shopimint_register_templates')
            );
            ...
            foreach (array_keys($this->templates) as $post_type) {
                add_filter(
                    'theme_' . $post_type . '_templates', array($this, 'shopimint_add_new_template')
                );
         ...
         */
        add_filter(
            'wp_insert_post_data', array($this, 'shopimint_register_templates')
        );
         ...
         */
        add_filter(
            'template_include', array($this, 'shopimint_view_template')
        );
     ...
     * @return array
     */
    public function shopimint_register_templates($atts)
    {
     ...
     * @return string
     */
    public function shopimint_view_template($template)
    {
